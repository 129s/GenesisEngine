...
- Sandbox GUI 依赖同一库的相机/命中测试/批次管理（参考提案 `docs/architecture/proposals/interface/sandbox/sandbox-gui-tilemap-rendering.md` 与实现说明 `docs/architecture/interface/sandbox/sandbox-gui-scene-unification.md`），Game 客户端复用核心并替换策略与叠加层。
