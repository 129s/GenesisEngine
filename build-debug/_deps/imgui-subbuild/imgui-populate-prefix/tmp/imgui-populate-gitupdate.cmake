...
function(do_fetch)
  ...
  execute_process(
    COMMAND "E:/msys64/usr/bin/git.exe" --git-dir=.git fetch --tags --force "origin"
...
function(get_hash_for_ref ref out_var err_var)
  execute_process(
    COMMAND "E:/msys64/usr/bin/git.exe" --git-dir=.git rev-parse "${ref}^0"
    WORKING_DIRECTORY "L:/CppProject/GenesisEngine/build-debug/_deps/imgui-src"
...
execute_process(
  COMMAND "E:/msys64/usr/bin/git.exe" --git-dir=.git show-ref "v1.91.0-docking"
  WORKING_DIRECTORY "L:/CppProject/GenesisEngine/build-debug/_deps/imgui-src"
...
if(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/remotes/")
  ...
  set(checkout_name "v1.91.0-docking")
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("v1.91.0-docking" tag_sha error_msg)
  if(tag_sha STREQUAL head_sha)
    message(VERBOSE "Already at requested tag: v1.91.0-docking")
    return()
  endif()
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(checkout_name "origin/v1.91.0-docking")
  ...
  elseif(tag_sha STREQUAL "")
    ...
    if(NOT can_fetch)
      message(FATAL_ERROR
        "Requested git ref \"v1.91.0-docking\" is not present locally, and not "
...
if(git_update_strategy MATCHES "^REBASE(_CHECKOUT)?$")
  ...
  execute_process(
    COMMAND "E:/msys64/usr/bin/git.exe" --git-dir=.git symbolic-ref -q HEAD
    WORKING_DIRECTORY "L:/CppProject/GenesisEngine/build-debug/_deps/imgui-src"
  ...
  if(current_branch STREQUAL "")
    ...
    execute_process(
      COMMAND "E:/msys64/usr/bin/git.exe" --git-dir=.git for-each-ref "--format=%(upstream:short)" "${current_branch}"
      WORKING_DIRECTORY "L:/CppProject/GenesisEngine/build-debug/_deps/imgui-src"
...
execute_process(
  COMMAND "E:/msys64/usr/bin/git.exe" --git-dir=.git status --porcelain
  WORKING_DIRECTORY "L:/CppProject/GenesisEngine/build-debug/_deps/imgui-src"
  RESULT_VARIABLE error_code
...
if(need_stash)
  execute_process(
    COMMAND "E:/msys64/usr/bin/git.exe" --git-dir=.git stash save --quiet;--include-untracked
    WORKING_DIRECTORY "L:/CppProject/GenesisEngine/build-debug/_deps/imgui-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  execute_process(
    COMMAND "E:/msys64/usr/bin/git.exe" --git-dir=.git checkout "${checkout_name}"
    WORKING_DIRECTORY "L:/CppProject/GenesisEngine/build-debug/_deps/imgui-src"
    COMMAND_ERROR_IS_FATAL ANY
    ${maybe_show_command}
  )
  ...
  execute_process(
    COMMAND "E:/msys64/usr/bin/git.exe" --git-dir=.git rebase "${checkout_name}"
    WORKING_DIRECTORY "L:/CppProject/GenesisEngine/build-debug/_deps/imgui-src"
    RESULT_VARIABLE error_code
  ...
  if(error_code)
    ...
    execute_process(
      COMMAND "E:/msys64/usr/bin/git.exe" --git-dir=.git rebase --abort
      WORKING_DIRECTORY "L:/CppProject/GenesisEngine/build-debug/_deps/imgui-src"
      ${maybe_show_command}
    )
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      if(need_stash)
        execute_process(
          COMMAND "E:/msys64/usr/bin/git.exe" --git-dir=.git stash pop --index --quiet
          WORKING_DIRECTORY "L:/CppProject/GenesisEngine/build-debug/_deps/imgui-src"
          ${maybe_show_command}
          )
      endif()
      message(FATAL_ERROR "\nFailed to rebase in: 'L:/CppProject/GenesisEngine/build-debug/_deps/imgui-src'."
    ...
    execute_process(
      COMMAND "E:/msys64/usr/bin/git.exe" --git-dir=.git tag -a
...
if(need_stash)
  ...
  if(error_code)
    ...
    execute_process(
      COMMAND "E:/msys64/usr/bin/git.exe" --git-dir=.git reset --hard --quiet
      WORKING_DIRECTORY "L:/CppProject/GenesisEngine/build-debug/_deps/imgui-src"
      ${maybe_show_command}
    )
    execute_process(
      COMMAND "E:/msys64/usr/bin/git.exe" --git-dir=.git stash pop --quiet
      WORKING_DIRECTORY "L:/CppProject/GenesisEngine/build-debug/_deps/imgui-src"
      RESULT_VARIABLE error_code
      ${maybe_show_command}
    )
    if(error_code)
      ...
      execute_process(
        COMMAND "E:/msys64/usr/bin/git.exe" --git-dir=.git reset --hard --quiet ${head_sha}
        WORKING_DIRECTORY "L:/CppProject/GenesisEngine/build-debug/_deps/imgui-src"
        ${maybe_show_command}
      )
      execute_process(
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'L:/CppProject/GenesisEngine/build-debug/_deps/imgui-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
