...
execute_process(
  COMMAND "E:/msys64/usr/bin/git.exe" --git-dir=.git show-ref "v1.14.0"
  WORKING_DIRECTORY "L:/CppProject/GenesisEngine/build-debug/_deps/gtest-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'L:/CppProject/GenesisEngine/build-debug/_deps/gtest-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'L:/CppProject/GenesisEngine/build-debug/_deps/gtest-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
