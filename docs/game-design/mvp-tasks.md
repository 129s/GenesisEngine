...
## 里程碑映射（对 `mvp.md`）
- M0：R1/R2 + S1 + G1/G2 + XR1/XR2/XR3（渲染内核/策略/基础叠加）
- M1：R3/R4 + S2 + G5 + XR5/XR6（知识雾/零素材主题与图案库基础）
- M2：R5/R6 + G3/G4/G7 + XR9/XR10/XR11（木/砖材质、门/柜台Schema、像素光照与磨损）
- M3：R7/R8 + S3 + G8 + XR7/XR8/XR12（图标与图例、可访问性、确定性与锚定）
